...
import { Login,Signup,WhatWouldYouLike,WhereYouAre,SearchMap,Home,Message,Chat,Setting ,FilterMyList,FilterMyMap} from './../Screens/index';
    ...
    return (
        <NavigationContainer>
            <Stack.Navigator>
                ...
                <Stack.Screen name="FilterMyMap" component={FilterMyMap} options={{ headerShown: false }} />
            </Stack.Navigator>
        </NavigationContainer>
    );
}
